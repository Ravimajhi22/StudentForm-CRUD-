export const COUNTRY_CODES = [
  ...
  { name: "American Samoa", code: "+1", iso: "AS" },
  { name: "Andorra", code: "+376", iso: "AD" },
  { name: "Angola", code: "+244", iso: "AO" },
  { name: "Anguilla", code: "+1", iso: "AI" },
  ...
  { name: "British Virgin Islands", code: "+1", iso: "VG" },
  ...
  { name: "Cayman Islands", code: "+1", iso: "KY" },
  ...
  { name: "Northern Mariana Islands", code: "+1", iso: "MP" },
  ...
  { name: "Turks and Caicos Islands", code: "+1", iso: "TC" },
  ...
  { name: "Virgin Islands, British", code: "+1", iso: "VG" },
  { name: "Virgin Islands, U.S.", code: "+1", iso: "VI" },
